          ...
          >
            <h2 className="text-3xl font-bold mb-6">About Me</h2>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-5">
                ...
                <p>My first time programming was when my high school first introduced a programming class. I didnt enjoy the class
                  ...
                  our development of the vaccine and I realized that coding was more than just turtle code. I also learned about the world of sneaker reselling
                  and how people were using software to increase their chance of getting a limited shoe. I tried creating my own software but realized the complexity 
                  of anti-bot measures. This sparked my interest in Computer Science. 
                </p>
              </div>
